...
import com.wanda.ysh.tool.ToolUtils;
...
/**
 * 类RedisExample.java的实现描述：TODO 类实现描述 
 * @author yangshihong Apr 22, 2015 3:52:25 PM
 */
public class RedisClient {

    private static final long maxWait = 5000l;
    private static final String redisServer = "127.0.0.1";
...
//        shardedJedisPool.returnResource(shardedJedis);
    ...
    /** 
     * 使用JedisPoolConfig操作redis,有3个配置项要注意:
     * maxTotal minIdle maxTotal，maxTotal默认是8，maxTotal要大于等于maxIdle，否则设置 minIdle和 maxTotal的目的。
     * 例如配置成
     * minIdle=10
     * maxIdle=50
     * maxTotal=默认值（不配置）
     * 结果会是：minIdle=8  maxIdle=8
     */ 
    private void initialShardedPool() {
        ...
        shardedJedisPool.getResource().getShard("");
    } 
    ...
    public void devTest() {
       ...
       //在空闲时检查有效性, 默认false
        config.setTestWhileIdle(false);
        // redisMasterHost=10.77.144.236
//        redisMasterPort=10342
        List<JedisShardInfo> shards = new ArrayList<JedisShardInfo>(); 
//        shards.add(new JedisShardInfo("10.77.144.236", 10342,"master1")); 
//        shards.add(new JedisShardInfo("10.77.144.237", 10342,"slave1")); 
        /** 成都新分配redis */
//        shards.add(new JedisShardInfo("10.209.33.39", 10414,"master1" )); 
//        shards.add(new JedisShardInfo("10.209.36.18", 10414,"master2"));
//        shards.add(new JedisShardInfo("10.209.37.40", 10414,"slave1"));
//        shards.add(new JedisShardInfo("10.209.32.198", 10414,"slave2"));
        shards.add(new JedisShardInfo("r10414.wdds.redis.com", 10414));

        // 构造池 
        ShardedJedisPool pool = new ShardedJedisPool(config, shards);
        ShardedJedis  shardedJedis = pool.getResource();
//        jedis.set("parkingTes1t","hello");
        System.out.println(shardedJedis.get("parkingTes1t"));
    }

    public void operateKV() {
        System.out.println("开始添加key");
        ...
        int randomN = ToolUtils.getRandomBetweenMaxAndMin(0, recycle);
        long endGet = System.currentTimeMillis();
        System.out.println(jedis.get("key"+randomN));
        System.out.println("随机获取值耗时(ms):"+(endGet- startGet));
        long end = System.currentTimeMillis();
        System.out.println("每秒插入的记录数:"+(recycle*1000/(end-start)));
        System.out.println("总耗时(ms):"+(end-start));
        System.out.println("结束添加key");
    }
    ...
    { 
        ...
        System.out.println("新增key000,value000键值对："+jedis.set("key000", "value000")); 
    ...
    {  
        ...
        System.out.println("新增3个键值对如下：");
        System.out.println(jedis.set("***","value001"));
        System.out.println(jedis.set("key001","value001"));
        System.out.println(jedis.set("key002","value002"));
        System.out.println(jedis.set("key003","value003"));
...
//        System.out.println("hashs中的所有值："+shardedJedis.hkeys("hashs"));
//        System.out.println("hashs中的所有值："+shardedJedis.hvals("hashs"));
        System.out.println("all key-val"+shardedJedis.hgetAll("hashs"));
        System.out.println("all key-val"+shardedJedis.hgetAll("hashs11"));
        shardedJedis.hkeys("hashs");
//        shardedJedis.hg
//        shardedJedis.expire(key, seconds)
        System.out.println("=============删=============");
        System.out.println("hashs中删除key002键值对："+shardedJedis.hdel("hashs", "key*"));
//        System.out.println();
//        
//        System.out.println("=============改=============");
