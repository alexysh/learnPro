...
/**
 * 类DistributedLock.java的实现描述：TODO 类实现描述 
 * @author yangshihong Mar 2, 2017 9:53:23 AM
 */
...
public class DistributedLock {
    ...
    private static final String CONNECTION_STRING = "127.0.0.1:2181,127.0.0.1:2182,127.0.0.1:2182,127.0.0.1:2183";
    ...
    public DistributedLock(String root) {
        try {
            this.zookeeper = new ZooKeeper(CONNECTION_STRING, SESSION_TIMEOUT, new TestWatcher());
            this.root = root;
            ensureExists(root);
        } catch (IOException e) {
            logger.error(e);
